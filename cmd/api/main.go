...
func main() {
	...
	tagRepo := pgsqlRepository.NewPgsqlTagRepository(dbInstance)
	...
	tagUC := usecase.NewTagUsecase(tagRepo, redisRepo, ctxTimeout)
	...
	httpDelivery.NewTagHandler(e, appMiddleware, tagUC)
